            ...
            <div class="row">
                <div class="card-body">
                    ...
                    <?php if (!$tanggalAwal && !$tanggalAkhir) :  ?>
                        ...
                        <h6 class="font-weight-bold mt-2 text-primary">Laporan Surat Keluar tanggal <?= date('d F Y'); ?></h6>
                    <?php else : ?>
                        ...
                        <h6 class="font-weight-bold mt-2 text-primary">Laporan surat keluar tanggal <?= $newTanggalAwal . ' s/d ' . $newTanggalAkhir ?></h6>
                    <?php endif; ?>
