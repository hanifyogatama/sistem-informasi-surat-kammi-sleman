                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input type="text" name="id_surat_masuk" id="id_surat_masuk" class="form-control" value="<?= $surat_masuk['id_surat_masuk'] ?>" readonly>
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input type="text" name="id_status_surat" id="id_status_surat" class="form-control" value="<?= $surat_masuk['id_status_surat'] ?>" readonly>
